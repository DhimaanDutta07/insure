...
exports.insuredMemberSchema = zod_1.z.object({
    id: zod_1.z.string().uuid().optional(),
    insured_member_salutation: zod_1.z.string().max(50).optional().nullable(),
    name: zod_1.z.string().min(1).max(255).optional(),
    relation_to_proposer: zod_1.z.string().min(1).max(50).optional(),
    date_of_birth: dateOrDateTime.optional(),
    gender: exports.GenderEnum.optional(),
    pre_existing: zod_1.z.boolean().optional().nullable(),
    insured_member_medical_condition: zod_1.z.boolean().optional().nullable(),
    insured_member_medical_remarks: zod_1.z.string().max(1000).optional().nullable(),
...
exports.insurancePolicySchema = zod_1.z.object({
    ...
    deductible_amount: zod_1.z.number().min(0).optional().nullable(),
...
exports.policyResponseSchema = zod_1.z.object({
    ...
    deductible_amount: zod_1.z.number().optional().nullable(),
    deductible_amount_status: zod_1.z.boolean().optional(),

...
exports.commissionRuleSearchSchema = exports.commissionRuleUpdateSchema = exports.commissionRuleSchema = exports.SIConditionEnum = exports.ProductTypeEnum = exports.AgeConditionEnum = exports.DeductibleTypeEnum = exports.PolicyCreationStatusEnum = void 0;
...
exports.ProductTypeEnum = zod_1.z.nativeEnum(client_1.ProductType);
exports.SIConditionEnum = zod_1.z.nativeEnum(client_1.SICondition);
...
exports.commissionRuleSearchSchema = zod_1.z.object({
    ...
    siCondition: zod_1.z.string().optional(),

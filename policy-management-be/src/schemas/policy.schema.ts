...
export const insuredMemberSchema = z.object({
  id: z.string().uuid().optional(),
  insured_member_salutation: z.string().max(50).optional().nullable(),
  name: z.string().min(1).max(255).optional(),
  relation_to_proposer: z.string().min(1).max(50).optional(),
  date_of_birth: dateOrDateTime.optional(),
  gender: GenderEnum.optional(),
  pre_existing: z.boolean().optional().nullable(),
  insured_member_medical_condition: z.boolean().optional().nullable(),
  insured_member_medical_remarks: z.string().max(1000).optional().nullable(),
...
export const insurancePolicySchema = z.object({
  ...
  deductible_amount: z.number().min(0).optional().nullable(),
